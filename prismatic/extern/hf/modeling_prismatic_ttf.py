...
class PrismaticVisionBackbone(nn.Module):
    ...
    def forward(self, pixel_values: torch.Tensor) -> torch.Tensor:
        ...
        """
        assert self.num_images_in_input == 1
...
class OpenVLAForActionPredictionTTF(PrismaticForConditionalGeneration):
    ...
    def _regression_or_discrete_prediction(
        ...
        self.vision_backbone.manager.last_attention_layers = language_model_output.attentions
